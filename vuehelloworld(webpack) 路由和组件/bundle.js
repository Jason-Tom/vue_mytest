...
/***/ function(module, exports, __webpack_require__) {
	...
	var lalala = __webpack_require__(1);
	...
	var hahaha = __webpack_require__(3);
	hahaha.world();
	// var jjj=new hahaha();
	// jjj.world();

	var aaa = __webpack_require__(4);
	aaa.a();
	// 能重复使用
...
/***/ function(module, exports) {
	...
	// 这种方法直接就是对象，导入后不用创建对象,也不能创建对象（module相当于再复制一份，效率没有这个方法高）
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./node_modules/.0.25.0@css-loader/index.js!./mycss.css", function() {
				var newContent = require("!!./node_modules/.0.25.0@css-loader/index.js!./mycss.css");
...
/***/ function(module, exports) {
	...
	module.exports = "\n<h2>Hello, World22222!</h2> {{greeting}}\n<button @click='gagaga'>点我</button>\n";
